...
## 2、本脚本使用的**解析接口全部收集自互联网（注意：解析出来的视频质量问题本脚本并不能处理）**

## 3、重音问题(部分用户偶发现象)：1).网速加载过慢导致 2).观看的资源访问压力过大,导致加载速度过慢 解决办法：重新刷新页面即可

4、本插件是公开免费发布的，**如果某个解析接口存在侵权行为，请联系该接口站长处理！**

5、有一些解析接口包含广告，请大家切勿相信，好工具大家享

6、**如遇到问题请反馈的时候提供URL地址，好快速解决问题，谢谢！！！**
